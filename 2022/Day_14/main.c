...
// Convert (x, y) coordinates from the map space to the array space
...
int main()
{
    ...
    while (fgets(line, sizeof(line), input))
    {
        ...
        x_start = strtol(token,NULL,10);
        token = strtok(NULL, delimiters);
        y_start = strtol(token,NULL,10);
        token = strtok(NULL, delimiters);
        ...
        while (token)
        {
            ...
            x_end = strtol(token,NULL,10);
            token = strtok(NULL, delimiters);
            y_end = strtol(token,NULL,10);
    ...
    /* Note:
        ...
        sand fills the map to the top, it forms an equilateral triangle. Each layer of the
    ...
    */
    ...
    while (current_wall)
    {
        ...
        // The direction in which the wall is drawn
    ...
    while (true)
    {
        ...
        // Check the contents of the 3 adjacent spaces below the sand
